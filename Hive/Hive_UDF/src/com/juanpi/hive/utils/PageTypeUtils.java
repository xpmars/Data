package com.juanpi.hive.utils;

import java.util.List;
import com.juanpi.hive.udf.GetSiteId;
import com.juanpi.hive.utils.PageIDChecker.Page_Pattern;
...
public class PageTypeUtils {
	...
	public static Integer getPageID(String url) {
		...
		url = url.trim();
		if (-999 == new GetSiteId().evaluate(url)) {
			// 站外页，直接返回
			return -999;
		}
		List<Page_Pattern> patterns = PageIDChecker.patterns;
